...
> 实施状态（2026-08-02）：本文是早期设计稿。当前系统已使用 `fixed_cache` 固定轨迹、
> 激光稳定滤波/自动扫描阶段判断、RS485 毛刷和 HMI 热重载。生产行为以
> `src/panthera_spectrometer_cell/README.md`、`docs/EXTERNAL_COMMAND_API.md` 和
> `AGENTS.md` 为准；本文中“建议新建”“后续接 MoveIt”等描述不再是待办。
